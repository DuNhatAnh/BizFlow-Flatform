...
namespace BizFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260731133016_AddTenantSubscriptionDetails")]
    partial class AddTenantSubscriptionDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BizFlow.Domain.Entities.BankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BizFlow.Domain.Entities.IdempotentRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BizFlow.Domain.Entities.TaxLedgerEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("tax_ledger_entries", (string)null);
                });
            ...
            modelBuilder.Entity("BizFlow.Domain.Entities.CashTransaction", b =>
                {
                    b.HasOne("BizFlow.Domain.Entities.BankAccount", "BankAccount")
                        .WithMany()
                        .HasForeignKey("BankAccountId");

                    b.HasOne("BizFlow.Domain.Entities.ExpenseRecord", "ExpenseRecord")
                        .WithMany()
                        .HasForeignKey("ExpenseRecordId");

                    b.HasOne("BizFlow.Domain.Entities.InventoryReceipt", "InventoryReceipt")
                        .WithMany()
                    ...
                    b.HasOne("BizFlow.Domain.Entities.PayrollRecord", "PayrollRecord")
                        .WithMany()
