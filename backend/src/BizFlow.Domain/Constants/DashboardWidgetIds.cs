...
{
    public const string KpiRevenue = "kpi-revenue";
    ...
    public const string ListTopProducts = "list-top-products";
    public const string ListTopDebtCustomers = "list-top-debt-customers";
    
    public const string AlertLowStock = "alert-low-stock";
}
